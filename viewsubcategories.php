   ...
   <div class="categories-shop">
    <div class="container">
        <div class="row">
            <?php
            $catid = $_REQUEST['id'];
            $subcatqry = "SELECT * FROM subcategories WHERE catid='".$catid."' ORDER BY id DESC";
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <a href="viewproduct.php?catid=<?php echo $catid; ?>&subcatid=<?php echo $subcatrow['id']; ?>" class="subcategory-link">
                        <div class="shop-cat-box">
                            <img class="img-fluid" src="images/subcategories/<?php echo $subcatrow['image']; ?>" alt="<?php echo $subcatrow['subcatname']; ?>">
